...
print(data)
#estimator=AgglomerativeClustering(n_clusters=10,linkage='ward')
estimator=KMeans(n_clusters=8)#12
#estimator=MeanShift()
estimator.fit(data)
...
plt.scatter(X_pca[:,1], X_pca[:,0], color=colr)
plt.show()
for i in clusters:
